...
/**
 * A type of plugin that can be executed on the grid.
 * @author Fabien Campagne
 *         Date: 10/28/11
 *         Time: 6:07 PM
 */
@XmlSeeAlso({AlignerConfig.class, AlignmentAnalysisConfig.class})
public class ExecutablePluginConfig extends PluginConfig {
     /**
