...
/**
 ** Resolve dependencies against a GobyWeb PluginRepository.
 */
public class StatefulDependencyResolver  {

    private PluginRegistry pluginConfigs = PluginRegistry.getRegistry();

    public StatefulDependencyResolver(PluginRegistry pluginConfigs) {
    ...
    /**
      ...
      */
     public  ResourceConfig resolveResource(String resourceId) {
     ...
     * @return Most recent resource (by version number) with id and version>v
     */
    public  ResourceConfig resolveResource(String resourceId, String versionAtLeast) {
     ...
     * @return Most recent resource (by version number) with id and version>v
     */
    public  ResourceConfig resolveResource(String resourceId, String versionAtLeast, String versionExactly) {
     ...
     * @return Most recent resource (by version number) with id and version>v
     */
    public ResourceConfig resolveResource(String resourceId, String versionAtLeast, String versionExactly, String versionAtMost) {
     ...
     * @return Most recent resource (by version number) with id and version>v
     */
    public FileSetConfig resolveFileSet(String fileSetId, String versionAtLeast, String versionExactly, String... versionAtMost) {
    ...
    public FileSetConfig resolveFileSetFromMimeType(String mimeType) {
