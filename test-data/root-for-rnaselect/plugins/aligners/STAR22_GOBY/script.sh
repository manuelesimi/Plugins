...
function plugin_align {
     ...
     ORG=${RESOURCES_ARTIFACTS_STAR_INDEX_ORGANISM}
     BUILD_NUMBER=${RESOURCES_ARTIFACTS_STAR_INDEX_REFERENCE_BUILD}
     ENSEMBL_RELEASE=${RESOURCES_ARTIFACTS_STAR_INDEX_ENSEMBL_VERSION_NUMBER}
     ...
     ${RESOURCES_SAMTOOLS_EXEC_PATH} calmd -u sam_sorted.bam ${INDEXED_GENOME_DIR}/*toplevel.fasta.gz >Aligned.out.bam
